      ...
      <div className="relative overflow-hidden rounded-3xl bg-[#f3ede7] shadow-sm">
        <div className="flex flex-col md:flex-row items-center">
          <div className="p-8 md:p-12 md:w-1/2 flex flex-col items-start z-10 space-y-4">
            ...
            <button 
              onClick={() => onSelectProduct(MOCK_ITEMS[2])}
      ...
      <section>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
          ...
          <div className="group cursor-pointer text-center hidden lg:block">
            <div className="aspect-square w-full overflow-hidden rounded-full border-4 border-transparent group-hover:border-[#ec8013] transition-all shadow-sm">
              <img alt="Drinks" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" src="https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&q=80&w=400" />
            </div>
          ...
          {MOCK_ITEMS.slice(0, 4).map((item) => (
            ...
            >
              <div className="relative w-40 h-40 mb-4">
                <img alt={item.name} className="w-full h-full object-cover rounded-full shadow-md transition-transform group-hover:scale-105" src={item.image} />
              ...
              <div className="text-[10px] font-black text-[#9a734c] uppercase tracking-widest mb-1">{item.restaurant}</div>
